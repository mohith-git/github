...
def short_range(f):
          ...
          return render_template('sr.html',x=Short_range(f),a=Regions(f)[0],b=Regions(f)[1],c=Regions(f)[2])

@app.route("/mr/")
@app.route("/mr/<f>")
def medium_range(f):
          
          return render_template('mr.html',x=Medium_range(f),a=Regions(f)[0],b=Regions(f)[1],c=Regions(f)[2])
